...
urlpatterns = [
    ...
    path('category/<int:pk>',views.first_categoryView.as_view(),name='category'),
    path('category/<int:pk>/<int:pagenum>',views.categoryView.as_view(),name='category'),
    path('category/<int:pk>',views.first_single_categoryView.as_view(),name='category'),
    path('category/<int:pk>/<int:pagenum>',views.single_categoryView,name='category'),
